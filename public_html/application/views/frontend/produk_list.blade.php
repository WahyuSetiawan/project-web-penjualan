							...
							<div class="widget-content">
								<ul class="list-unstyled">
									<?php foreach ($categori as $rows): ?>
										<li>
											<a href="<?php echo site_url('home/kategori/'.$rows->id_kategori) ?>"><i class="fa fa-angle-double-right"></i><?php echo $rows->nama_kategori ?></a>
										</li>
									<?php endforeach ?>
						...
						<div class="widget widget-recent-products">
							...
							<div class="widget-content">
								...
								<?php foreach ($related as $row): ?>
									...
									<div class="product">
										<img src="<?php echo base_url().$row->gambar_1 ?>" alt="product" style=" margin: 0 3px 2px 0; -o-object-fit: none; object-fit: cover;    width:20%;   height:50px;"/>
										<div class="product-desc">
											<div class="product-title">
												<a href="<?php echo site_url('home/detail/'.$row->id_produk) ?>"><?php echo $row->nama_produk ?></a>
											</div>
											<div class="product-meta">
												<span class="color-theme">Rp.<?php echo number_format($row->harga_produk) ?></span>
											</div>
										</div>
									</div>
