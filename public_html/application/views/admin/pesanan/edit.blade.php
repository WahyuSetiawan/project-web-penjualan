			...
			<table id="example4" class="display" style="width:100%">
				...
				<?php foreach ($detail_pesan as $r) {?>
					<tr>
						<form>
							<td>
								<input type="text" name="" value="<?php echo $r->nama_produk ?>" class="form-control">
							</td>
							<td>
								<input type="text" name="" value="<?php echo $r->harga_produk ?>" class="form-control">
							</td>
				...
				<div class="tambah_baru" style="display: none">
					<form method="post" action="<?php echo site_url('admin/pesanan/ubah/' . $pesanan[0]->id_pesanan) ?>">
