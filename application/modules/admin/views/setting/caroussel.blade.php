                            ...
                            <nav>
                                ...
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link {{$active}}" id="nav-home-tab" data-toggle="tab"
                                        href="#nav-carousell-{{$item->id_carousell}}" role="tab"
                                        aria-controls="nav-carousell-{{$item->id_carousell}}"
                                        aria-selected="true">{{$item->title}}
                                ...
                                <div class="tab-pane fade show {{$active}}" id="nav-carousell-{{$item->id_carousell}}"
                                    ...
                                    <div class="row">
                                        <div class="col col-md-4">
                                            <img class="img-preview" src="{{base_url($item->img)}}"
                                                data-index="{{$item->id_carousell}}">
                                        </div>
                                        <div class="col col-md-5 col-md-offset-1">
                                            <div class="row">
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input"
                                                            class=" form-control-label">Background</label>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="content[{{$item->id_carousell}}]"
...
<div id="template-tab-carousell" style="display: none">
    <a class="nav-item nav-link" data-toggle="tab" href="" role="tab" aria-controls="" aria-selected="false"><i
            class="fa fa-plus">
        </i></a>
</div>
