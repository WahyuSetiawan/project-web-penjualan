  ...
  <?php foreach ($produk as $row): ?>
    <tr>
      ...
      <td>
        ...
        <a href="<?php echo site_url('admin/produk/hapus/'.$row->id_produk) ?>" onclick="return confirm('Anda Yakin Ingin Menghapus ?')"><button class="btn btn-danger btn-sm">Hapus</button></a>
